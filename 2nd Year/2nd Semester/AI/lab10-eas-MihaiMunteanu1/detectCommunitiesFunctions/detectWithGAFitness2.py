...
from GA import GA
from fitnessFunctions.fitness import new_fitness2, modularity


def detect_communities_with_ga_fitness2(network, pop_size=100, num_generations=100, pc=0.8, pm=0.1):
    ...
    problem_param = {
        ...
        'function': lambda communities: new_fitness2(communities, network),
        'noBits': 8
    }
